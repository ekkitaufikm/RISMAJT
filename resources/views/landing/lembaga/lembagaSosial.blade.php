    ...
    <head>
        ...
        <div class="navbar navbar-expand-lg bg-dark navbar-dark">
            <div class="container-fluid">
                <a href="/" class="navbar-brand">RISMAJT</a>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="landing/img/foto-foto/fotoLembaga/lembagaSosial/faiq.png" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>Faiq Raihan</h2>
                                <p>Web Developer RISMAJT</p>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-contact">
                            ...
                            <p><i class="fa fa-envelope"></i>humasrisma@rismajt.or.id</p>
