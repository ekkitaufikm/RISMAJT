...
<div class="content">
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-4">
        <a href="{{ url('pengumuman/create') }}"><button class="btn btn-primary btn-block" {{-- onclick="md.showNotification('top','right')" --}}>Tambahkan Pengumuman</button></a>
      </div>
      <div class="col-md-12">
        <div class="card card-plain">
          <div class="card-header card-header-primary">
            <h4 class="card-title mt-0"> Data Pengumuman</h4>
